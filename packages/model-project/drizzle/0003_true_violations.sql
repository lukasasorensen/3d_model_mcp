CREATE TYPE "public"."render_delivery_mode" AS ENUM('chat', 'remote-mcp');--> statement-breakpoint
CREATE TABLE "jwks" (
...
--> statement-breakpoint
ALTER TABLE "browser_render_jobs" ALTER COLUMN "session_id" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "browser_render_jobs" ALTER COLUMN "token_hash" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "browser_render_jobs" ADD COLUMN "delivery_mode" "render_delivery_mode" DEFAULT 'chat' NOT NULL;--> statement-breakpoint
ALTER TABLE "browser_render_jobs" ADD COLUMN "claim_deadline" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "browser_render_jobs" ADD COLUMN "claimed_at" timestamp with time zone;--> statement-breakpoint
...
CREATE INDEX "browser_render_jobs_claim_idx" ON "browser_render_jobs" USING btree ("owner_id","project_id","delivery_mode","state");